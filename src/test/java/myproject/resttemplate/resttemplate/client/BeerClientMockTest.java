...
import myproject.resttemplate.resttemplate.config.RestTemplateBuilderConfig;
...
class BeerClientMockTest {
    ...
    void setUp() throws JsonProcessingException {
        ...
        RestTemplate restTemplate = restTemplateBuilderConfigured.build(); //Utowrzenie instancji restTemplate z naszego domyślnego buildera

        /**
         * Zbudowanie restTemplate z naszego restTemplateBuilderConfig
         * Wziecie tego restTemplate i powiązadanie go z naszym serwerem
         * i w wyniku utworzenie nowej instancji serwera. Sprawia to że zamiast prosic o to spring
         * tworzymy to sami
         */
    ...
    void testListBeersWithQueryParam() throws JsonProcessingException {
        ...
        server.expect(method(HttpMethod.GET))
                ...
                .andExpect(header("Authorization", "Basic dXNlcjE6cGFzc3dvcmQ=")) //Ustawienie oczekiwania
                .andExpect(queryParam("beerName", "ALE"))
                .andRespond(withSuccess(response, MediaType.APPLICATION_JSON));

        Page<BeerDTO> responsePage = beerClient.listBeers("ALE", null, null,
                null, null);
    ...
    void testCreateBeer() {
        ...
        BeerDTO responseDTO = beerClient.creatBeer(dto);
        assertThat(responseDTO.getId()).isEqualTo(dto.getId());
